            ...
            <ScrollView contentContainerStyle={{ height: '100%' }}>
                <View className="flex items-center justify-center  min-h-[85vh] px-4">
                    ...
                    <Text className="text-gray-100 font-pregular mt-7 text-sm text-center">
                        Where creativity meets innovation: embark on a journey of limitless exploration with Aora on the fly 🎉
                    </Text>

                    <AppButton title="Continue with Email" handlePress={() => router.push('/(auth)/sign-in')} containerStyles='w-full mt-7' />
